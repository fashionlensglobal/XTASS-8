          ...
          <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://i.ibb.co/Rk3mnMY0/01-Premium-Class-Lexus.jpg" alt="Car" className="w-full h-full object-cover" />
                 ...
                 <div className="bg-gray-100 aspect-video relative group">
                    <img src="https://i.ibb.co/ym19xyWR/02-Business-Class-Mercedez.jpg" alt="Car Interior" className="w-full h-full object-cover" />
                    <button type="button" className="absolute top-2 right-2 bg-red-600 text-white p-1 text-xs opacity-0 group-hover:opacity-100 transition-opacity">Remove</button>
                 </div>
              </div>
